...
class SpreadsheetFieldRoute(BaseModel):
    woo_field: str
    target_column: str
    enabled: bool = True
...
class SpreadsheetSettings(BaseModel):
    enabled: bool = False
    workbook_path: str = "woo_sync_export.xlsx"
    worksheet_name: str = "Orders"
    field_routes: list[SpreadsheetFieldRoute] = Field(
        default_factory=lambda: [
            SpreadsheetFieldRoute(woo_field="id", target_column="OrderID", enabled=True),
            SpreadsheetFieldRoute(woo_field="date_created", target_column="CreatedAt", enabled=True),
            SpreadsheetFieldRoute(woo_field="currency", target_column="Currency", enabled=True),
            SpreadsheetFieldRoute(woo_field="billing.email", target_column="CustomerEmail", enabled=True),
            SpreadsheetFieldRoute(woo_field="total", target_column="OrderTotal", enabled=True),
            SpreadsheetFieldRoute(woo_field="total_tax", target_column="OrderTax", enabled=True),
        ]
    )
